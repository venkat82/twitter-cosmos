...
import VenkatTwitterVenkatTwitterTwitter from './venkat/twitter/venkat.twitter.twitter'
...
export default { 
  ...
  VenkatTwitterVenkatTwitterTwitter: load(VenkatTwitterVenkatTwitterTwitter, 'venkat.twitter.twitter'),
